...
class SeoAppError
{
     ...
     *
     * @param string $request incomming request
     * @param string|null $uri
     * @return bool
     */
    public function requestMatch(string $request, ?string $uri): bool
    {
     ...
     *
     * @param bool $test if testing, return the status code instead of setting it.
     * @return int|void normally, status code in testing mode
     */
    public function __uriToStatusCode(bool $test = false) // phpcs:ignore CakePHP.NamingConventions.ValidFunctionName.PublicWithUnderscore
    {
     ...
     * @return never
     */
    public function executeStatusCode(int $code)
    {
     ...
     * @return void
     */
    public function __uriToRedirect(): void // phpcs:ignore CakePHP.NamingConventions.ValidFunctionName.PublicWithUnderscore
    {
     ...
     * @return void
     */
    public function __uriToLevenshtein(): void // phpcs:ignore CakePHP.NamingConventions.ValidFunctionName.PublicWithUnderscore
    {
 ...
 * @author Nick Baker
 */
class SeoExceptionHandler extends HttpException // phpcs:ignore PSR1.Classes.ClassDeclaration.MultipleClasses
{
    /**
     ...
     * @return void
     */
    public static function handle($exception, $message = null): void
    {
 ...
 */
class GoneExecption extends HttpException // phpcs:ignore PSR1.Classes.ClassDeclaration.MultipleClasses
{
    /**
     * @param string|null $message
     * @param int $code
